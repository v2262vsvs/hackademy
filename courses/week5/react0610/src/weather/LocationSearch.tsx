...
export const LocationSearch: FC<LocationSearchProps> = ({onSearch}) => {
  ...
  return (
    <div>
      <label id="text">
        Add Location
        <input id="text" className="ml-1 mr-1 border border-transparent focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent inline-block p-1.5 shadow-xl rounded " type="text" value={locationSearch}
