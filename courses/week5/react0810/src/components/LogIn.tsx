...
class LogIn extends React.Component<SignUpProps, SignUpState> {
  ...
  handleChange = (event: any) => {
    ...
    switch (name) {
      case "firstname":
        this.setState({
          dat: { firstname: target.value, email: var2, password: var3 },
        });
        break;
      case "email":
        this.setState({
          dat: { firstname: var1, email: target.value, password: var3 },
        });
        break;
      case "password":
        this.setState({
          dat: { firstname: var1, email: var2, password: target.value },
        });
        break;
      default:
        break;
